...
(
    ...
    PRIORITY_ID       INTEGER NOT NULL,
    NAME              VARCHAR2(64 CHAR) NOT NULL,
    RATIONALE         VARCHAR2(1024 CHAR) NOT NULL,
    CORRECTIVE_ACTION VARCHAR2(2048 CHAR) NOT NULL,
    ...
    CONSTRAINT CLASS_FK1 FOREIGN KEY (CATEGORY_ID) REFERENCES JAWS_OWNER.CATEGORY (CATEGORY_ID) ON DELETE SET NULL,
    CONSTRAINT CLASS_FK2 FOREIGN KEY (TEAM_ID) REFERENCES JAWS_OWNER.TEAM (TEAM_ID) ON DELETE SET NULL,
    CONSTRAINT CLASS_FK3 FOREIGN KEY (PRIORITY_ID) REFERENCES JAWS_OWNER.PRIORITY (PRIORITY_ID) ON DELETE SET NULL,
    CONSTRAINT CLASS_AK1 UNIQUE (NAME),
    CONSTRAINT CLASS_CK1 CHECK (FILTERABLE IN ('Y', 'N')),
    CONSTRAINT CLASS_CK2 CHECK (LATCHABLE IN ('Y', 'N'))
);
...
(
    ...
    CONSTRAINT INSTANCE_FK1 FOREIGN KEY (CLASS_ID) REFERENCES JAWS_OWNER.CLASS (CLASS_ID) ON DELETE SET NULL
);
