...
(
    ...
    POINT_OF_CONTACT  VARCHAR2(64 CHAR) NOT NULL,
    ...
    CONSTRAINT CLASS_CK1 CHECK (PRIORITY IN ('P1_CRITICAL', 'P2_MAJOR', 'P3_MINOR', 'P4_INCIDENTAL')),
    CONSTRAINT CLASS_CK2 CHECK (FILTERABLE IN ('Y', 'N')),
    CONSTRAINT CLASS_CK3 CHECK (LATCHABLE IN ('Y', 'N'))
);
