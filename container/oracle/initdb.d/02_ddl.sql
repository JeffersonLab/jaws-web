...
CREATE SEQUENCE JAWS_OWNER.CED_SYNC_ID
    INCREMENT BY 1
    START WITH 1
    NOCYCLE
    NOCACHE
...
CREATE TABLE JAWS_OWNER.CED_SYNC_RULE
(
    CED_SYNC_RULE_ID INTEGER NOT NULL,
    ACTION_ID        INTEGER NOT NULL,
    QUERY            VARCHAR2(4000 CHAR) NOT NULL,
    SCREEN_COMMAND   VARCHAR2(512 CHAR) NULL,
    PV               VARCHAR2(64 CHAR) NULL,
    CONSTRAINT CED_SYNC_RULE_PK PRIMARY KEY (CED_SYNC_RULE_ID),
    CONSTRAINT CED_SYNC_RULE_AK1 UNIQUE (CED_SYNC_RULE_ID, ACTION_ID),
    CONSTRAINT CED_SYNC_RULE_FK1 FOREIGN KEY (ACTION_ID) REFERENCES JAWS_OWNER.ACTION (ACTION_ID) ON DELETE CASCADE
);
...
(
    ...
    PV                   VARCHAR2(64 CHAR) NULL,
    CED_ID               INTEGER NULL,
    CED_DEPLOYMENT       VARCHAR2(32 CHAR) NULL,
    CED_SYNC_RULE_ID     INTEGER NULL,
    ...
    CONSTRAINT ALARM_FK2 FOREIGN KEY (CED_SYNC_RULE_ID, ACTION_ID) REFERENCES JAWS_OWNER.CED_SYNC_RULE (CED_SYNC_RULE_ID, ACTION_ID) ON DELETE SET NULL
);
