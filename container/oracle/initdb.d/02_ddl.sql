...
(
    ...
    INVENTORY_PATH        VARCHAR2(128 CHAR) NOT NULL,
    EXTRA_INVENTORY_QUERY VARCHAR2(4000 CHAR) NULL,
...
(
    ...
    CONSTRAINT SYNC_RULE_FK1 FOREIGN KEY (ACTION_ID) REFERENCES JAWS_OWNER.ACTION (ACTION_ID) ON DELETE CASCADE,
    CONSTRAINT SYNC_RULE_FK2 FOREIGN KEY (SYNC_SERVER_ID) REFERENCES JAWS_OWNER.SYNC_SERVER (SYNC_SERVER_ID) ON DELETE CASCADE
);
