...
(
    ...
    CONSTRAINT NOTIFICATION_FK1 FOREIGN KEY (ALARM_ID) REFERENCES JAWS_OWNER.ALARM (ALARM_ID) ON DELETE SET NULL
);

CREATE TABLE JAWS_OWNER.OVERRIDE
(
    ALARM_ID         INTEGER NOT NULL,
    OVERRIDE         VARCHAR2(32 CHAR) NOT NULL,
    CONSTRAINT OVERRIDE_PK PRIMARY KEY (ALARM_ID, OVERRIDE),
    CONSTRAINT OVERRIDE_FK1 FOREIGN KEY (ALARM_ID) REFERENCES JAWS_OWNER.NOTIFICATION (ALARM_ID) ON DELETE SET NULL
);
