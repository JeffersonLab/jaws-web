...
-- Sync Rules
INSERT INTO JAWS_OWNER.SYNC_RULE (SYNC_RULE_ID, ACTION_ID, SYNC_SERVER_ID, QUERY, SCREEN_COMMAND, PV, DESCRIPTION, PROPERTY_EXPRESSION) VALUES (2, 2, 1, 't=Aperture', null, null, null, null);
...
INSERT INTO JAWS_OWNER.SYNC_RULE (SYNC_RULE_ID, ACTION_ID, SYNC_SERVER_ID, QUERY, SCREEN_COMMAND, PV, DESCRIPTION, PROPERTY_EXPRESSION) VALUES (18, 80, 2, 't=IOC', 'OTFLauncher ioc iocscreen -name {ElementName}', '{ElementName}:memblock', 'LERF IOCs', '!unpowered&!hallcontrolled&FunctionalType=''PRODUCTION''&Status=''AVAILABLE''');
...
INSERT INTO JAWS_OWNER.SYNC_RULE (SYNC_RULE_ID, ACTION_ID, SYNC_SERVER_ID, QUERY, SCREEN_COMMAND, PV, DESCRIPTION, PROPERTY_EXPRESSION) VALUES (14, 116, 2, 't=ODH', 'OTFLauncher odh odhspikes', '{ElementName}cal', 'LERF ODH', null);
...
INSERT INTO JAWS_OWNER.SYNC_RULE (SYNC_RULE_ID, ACTION_ID, SYNC_SERVER_ID, QUERY, SCREEN_COMMAND, PV, DESCRIPTION, PROPERTY_EXPRESSION) VALUES (19, 80, 3, 't=IOC', 'OTFLauncher ioc iocscreen -name {ElementName}', '{ElementName}:MEM_BLK_FREE', 'UITF IOCs', '!unpowered&!hallcontrolled&FunctionalType=''PRODUCTION''&Status=''AVAILABLE''');
INSERT INTO JAWS_OWNER.SYNC_RULE (SYNC_RULE_ID, ACTION_ID, SYNC_SERVER_ID, QUERY, SCREEN_COMMAND, PV, DESCRIPTION, PROPERTY_EXPRESSION) VALUES (20, 116, 3, 't=ODH', 'OTFLauncher odh odhspikes', '{ElementName}', 'UITF ODH', null);
...
-- Alarms
INSERT INTO JAWS_OWNER.ALARM (ALARM_ID, ACTION_ID, NAME, DEVICE, SCREEN_COMMAND, MASKED_BY, PV, MANAGED_BY, SYNC_ELEMENT_ID, SYNC_RULE_ID) VALUES (1, 2, 'Central Plug', null, null, null, 'IDA0I04T', null, null, null);
INSERT INTO JAWS_OWNER.ALARM (ALARM_ID, ACTION_ID, NAME, DEVICE, SCREEN_COMMAND, MASKED_BY, PV, MANAGED_BY, SYNC_ELEMENT_ID, SYNC_RULE_ID) VALUES (3, 2, 'IFY0IA1 Position', null, null, null, 'VRD0IA1AbsPosR', null, 18294, 2);
INSERT INTO JAWS_OWNER.ALARM (ALARM_ID, ACTION_ID, NAME, DEVICE, SCREEN_COMMAND, MASKED_BY, PV, MANAGED_BY, SYNC_ELEMENT_ID, SYNC_RULE_ID) VALUES (10, 2, 'Master Slit', null, null, null, 'ISL0I04DT', null, null, null);
INSERT INTO JAWS_OWNER.ALARM (ALARM_ID, ACTION_ID, NAME, DEVICE, SCREEN_COMMAND, MASKED_BY, PV, MANAGED_BY, SYNC_ELEMENT_ID, SYNC_RULE_ID) VALUES (6720, 2, 'Cathode X Position', null, null, null, 'psub_cx_pos', null, null, null);
INSERT INTO JAWS_OWNER.ALARM (ALARM_ID, ACTION_ID, NAME, DEVICE, SCREEN_COMMAND, MASKED_BY, PV, MANAGED_BY, SYNC_ELEMENT_ID, SYNC_RULE_ID) VALUES (6721, 2, 'Cathode Y Position', null, null, null, 'psub_cy_pos', null, null, null);
