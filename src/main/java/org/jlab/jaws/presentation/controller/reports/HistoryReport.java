 ...
 * @author ryans
 */
@WebServlet(name = "HistoryReport", urlPatterns = {"/reports/history"})
public class HistoryReport extends HttpServlet {

    @EJB
    NotificationHistoryFacade historyFacade;
    @EJB
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        getServletConfig().getServletContext().getRequestDispatcher(
                "/WEB-INF/views/reports/history.jsp").forward(request, response);
    }
}
