 ...
 * @author ryans
 */
@WebServlet(name = "RemoveComponent", urlPatterns = {"/ajax/remove-component"})
public class RemoveComponent extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            stat = "fail";
            error = "Unable to remove Component: Not authenticated / authorized (do you need to re-login?)";
