 ...
 * @author ryans
 */
@WebServlet(name = "AddActionKeyValueList", urlPatterns = {"/ajax/setup/add-action-key-value-list"})
public class AddActionKeyValueList extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            stat = "fail";
            error = "Unable to add Action Key Value List: Not authenticated / authorized (do you need to re-login?)";
