 ...
 * @author ryans
 */
@WebServlet(name = "AddAlarmKeyValueList", urlPatterns = {"/ajax/setup/add-alarm-key-value-list"})
public class AddAlarmKeyValueList extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            stat = "fail";
            error = "Unable to add Alarm Key Value List: Not authenticated / authorized (do you need to re-login?)";
