 ...
 * @author ryans
 */
@WebServlet(name = "SetOverride", urlPatterns = {"/ajax/set-override"})
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        switch (type) {
            ...
            case Shelved:
                ...
                value.setUnion(new ShelvedOverride("true".equals(oneshot), expirationLong, ShelvedReason.valueOf(reason), comments));
                break;
            case Latched:
