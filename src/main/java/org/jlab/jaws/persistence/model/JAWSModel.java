...
public class JAWSModel {
  ...
  public JAWSModel() {
    ...
    classModel.setTableColumns(
        Arrays.asList(new String[] {"name", "category", "priority", "contact"}));
    keyFields = new ArrayList<>();
    keyFields.add(new FieldDefinition("name", FieldType.STRING));
    ...
    instanceModel.setTableColumns(
        Arrays.asList(new String[] {"name", "class", "device", "location", "epicspv"}));
    keyFields = new ArrayList<>();
    keyFields.add(new FieldDefinition("name", FieldType.STRING));
    ...
    registrationModel.setTableColumns(
        Arrays.asList(
            new String[] {
              "name", "category", "class", "device", "location", "priority", "contact", "epicspv"
            }));
    keyFields = new ArrayList<>();
    keyFields.add(new FieldDefinition("name", FieldType.STRING));
